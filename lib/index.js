...
const App = props => {
  ...
  const [currentRect, setCurrentRect] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(null); // Store current rectangle being drawn
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const handleResize = () => {
      ...
      (0,_utils__WEBPACK_IMPORTED_MODULE_9__.redraw)(context, canvasRef, paths, circles, rectangles, emojis, currentCircle, currentRect, currentPath, props); // Redraw existing drawings based on new size
    };
  ...
  }, [paths, emojis, circles, rectangles, currentCircle, currentRect, currentPath]);
...
const Annotation = _ref => {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    const handleResize = () => {
      ...
      (0,_utils__WEBPACK_IMPORTED_MODULE_2__.redraw)(context, canvasRef, paths, circles, rectangles, emojis, currentCircle, currentRect, currentPath, otherProps); // Redraw existing drawings based on new size
    };
    window.addEventListener('resize', handleResize);
    handleResize(); // Set initial canvas size
  ...
  const draw = e => {
    ...
    if (currentTool === _constants__WEBPACK_IMPORTED_MODULE_1__.ANNOTATION_TOOLS.pen && drawing) {
      ...
      const canvas = canvasRef.current;
      const radiusPercent = Math.sqrt(Math.pow(offsetX / canvas.width - currentRect.x, 2) + Math.pow(offsetY / canvas.height - currentRect.y, 2));
  ...
  const stopDrawing = () => {
    ...
    if (currentTool === _constants__WEBPACK_IMPORTED_MODULE_1__.ANNOTATION_TOOLS.pen && drawing) {
      ...
      setDrawing(false);
    } else if (currentTool === _constants__WEBPACK_IMPORTED_MODULE_1__.ANNOTATION_TOOLS.rectangle && currentRect) {
...
/* harmony export */   calculateRectangleRadius: () => (/* binding */ calculateRectangleRadius),
...
/* harmony export */   onDrawRectangle: () => (/* binding */ onDrawRectangle),
...
;
function onDrawRectangle(_ref4) {
  let {
    ctx,
    center,
    radius,
...
const calculateRectangleRadius = (startPos, currentPos) => {
  return Math.sqrt(Math.pow(currentPos.x - startPos.x, 2) + Math.pow(currentPos.y - startPos.y, 2));
};
...
const redraw = (context, canvasRef, paths, circles, rectangles, emojis, currentCircle, currentRect, currentPath, props) => {
